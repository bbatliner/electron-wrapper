...
module.exports = {
  ...
  args: [
    ...
    { name: 'icon', alias: 'i', type: String, description: 'The name of the icon file to use.' },
    { name: 'out', alias: 'o', type: String, description: 'The output directory of the app.\nDefault: current directory', defaultValue: '.' },
